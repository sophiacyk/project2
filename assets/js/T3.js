...
//     high income
    ...
    var trace4 = {
      ...
      var layout = {
        ...
        width: 1000,
        height: 500,
          title: 'GOING TO COURT (COUNTRY NUMBER)',
          font: {
            family: "Tahoma",
            size: 12,
            color: '#7f7f7f'
      ...
      Plotly.newPlot('T3_bar', data, layout);
