...
d3.csv(file_url, function(err, data){
    ...
    // var tt1 = passNum(T6_list[0], income[3]);
    // console.log(tt1);
    ...
    // var tt4 = getArrY(T6_list, income[3]);
    console.log(tt4);
...
//     high income
    ...
    var trace4 = {
      ...
      var layout = {
        ...
        width: 1000,
        height: 500,
          title: 'GETTING A JOB (COUNTRY NUMBER)',
          font: {
            family: "Tahoma",
            size: 12,
            color: '#7f7f7f'
      ...
      Plotly.newPlot('T6_bar', data, layout);
