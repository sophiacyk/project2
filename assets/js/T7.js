...
//     high income
    ...
    var trace4 = {
      ...
      var layout = {
        ...
        width: 1000,
        height: 500,
          title: 'PROTECTING WOMEN FROM VIOLENCE (COUNTRY NUMBER)',
          font: {
            family: "Tahoma",
            size: 12,
            color: '#7f7f7f'
      ...
      Plotly.newPlot('T7_bar', data, layout);
