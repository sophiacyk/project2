...
//     high income
    ...
    var trace4 = {
      ...
      var layout = {
        ...
        width: 1000,
        height: 500,
          title: 'USING PROPERTY (COUNTRY NUMBER)',
          font: {
            family: "Tahoma",
            size: 12,
            color: '#7f7f7f'
      ...
      Plotly.newPlot('T2_bar', data, layout);
